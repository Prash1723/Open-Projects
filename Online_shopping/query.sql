...
UPDATE transactions a SET a.transaction_date = (SELECT b.last_transaction FROM customer_master b WHERE a.Customer_ID=b.ID);

UPDATE transactions SET transaction_date = '2023-01-24' WHERE Transaction_ID='transact4' AND Customer_ID='cust3';
