...
UPDATE customer_master SET Location_ID = CASE customer_name WHEN 'vijay' THEN 'ban' WHEN 'sushila' THEN 'sur' WHEN 'fernandas' THEN 'mum' WHEN 'shubham' THEN 'pun' WHEN 'shivani' THEN 'man' WHEN 'pooja' THEN 'luc' ELSE 'unknown' END;
